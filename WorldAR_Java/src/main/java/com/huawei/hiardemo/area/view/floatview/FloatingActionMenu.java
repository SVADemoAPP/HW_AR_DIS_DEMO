...
import com.huawei.hiardemo.area.view.floatview.animation.DefaultAnimationHandler;
import com.huawei.hiardemo.area.view.floatview.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    public Point getActionViewCenter() {
        ...
        point.x += mainActionView.getMeasuredWidth() / 2; //xhf
//        point.x += mainActionView.getMeasuredWidth() / 2-70; //xhf
